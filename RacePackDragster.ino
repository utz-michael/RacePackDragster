...
//  Serial.println(digitalRead(LachgasPlate));
  ...
  dataString += ";";
  dataString += String(3600.0/(zeituebergabe2/1000.0)*Abrollumfang *1.06 ); // Geschwindigkeit reifen korrektur
  dataString += ";";
  dataString += String(Abrollumfang*streckencounter * 1.06); // Strecke
  dataString += ";";
